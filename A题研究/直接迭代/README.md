...
本分支最新交付见[联合整合执行结果](联合整合_20260926/执行结果.md)：接收双方互补成果，并从216实验臂对照中再接收52项严格降时方案。111项导入及52项新增均独立官方复评一致。最终累计1500份方案五核平均加速比为P1 **3.81552207**、P2 **4.54636927**、P3 **4.66624686**；这不是从头统一算法成绩。

新入口、冻结比较与回滚见[使用与回滚](联合整合_20260926/使用与回滚.md)。整合控制器P2/P3通过预设场景门槛，P1未通过；保留成熟主干与精选库，整合版不替换默认入口，不追加控制器扩展及最终全量。代码和103项测试已完成，完整正负例及成本入库。

以下为队友及既有历史方法的说明。队友最近交付见[第十三轮结果](第十三轮成果/第十三轮结果.md)：1500份方案，相对第十二轮新增7个P1降时配置，P2/P3累计最佳不变，无退步。P1五核全部100图平均配对降时0.6081%；完整改善清单和COPY变化在成果目录。
